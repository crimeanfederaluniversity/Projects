<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="DecMain.aspx.cs" Inherits="KPIWeb.Decan.DecMain" %>
...
<h2>Список активных отчётов</h2>
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Visible="false" Text="Label"></asp:Label>
    <br />
    <style type="text/css">
        .vbutton
         {
             ...
             <Columns>  
                 ...
                 <asp:BoundField DataField="EndDate" HeaderText="Конечная дата отчёта" Visible="True" />
                    ...
                    <asp:TemplateField HeaderText="Подробнее">
                        <ItemTemplate>
                            <asp:Button ID="ButtonEditReport" runat="server" CssClass="vbutton" OnClientClick="showLoadPanel()"  CommandName="Select" Text="Просмотреть" Width="200px" CommandArgument='<%# Eval("ReportArchiveID") %>' OnClick="ButtonViewClick"/>
                        </ItemTemplate>
                    </asp:TemplateField>
