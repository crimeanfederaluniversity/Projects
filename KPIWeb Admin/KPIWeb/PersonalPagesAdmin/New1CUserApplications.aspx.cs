...
{
    public partial class New1CUserApplications : System.Web.UI.Page
    {
        ...
        private void RefreshGrid()
        {
            ...
            using (KPIWebDataContext kpiWebDataContext = new KPIWebDataContext())
            {
                ...
                {
                    rectorapp = (from a in kpiWebDataContext.Aplications where a.Confirmed == 0 && a.Active == true && a.FK_ApplicationType == 7 select a).ToList();
                }
