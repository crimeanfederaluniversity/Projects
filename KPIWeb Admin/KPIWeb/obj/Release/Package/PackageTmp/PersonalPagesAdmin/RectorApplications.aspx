<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RectorApplications.aspx.cs" Inherits="KPIWeb.PersonalPagesAdmin.RectorApplications" %>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
            <Columns>
              ...
              <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Описание обращения" Visible="True">
                    <ItemTemplate>
