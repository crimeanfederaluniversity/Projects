<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="NewEquipmentApplications.aspx.cs" Inherits="KPIWeb.PersonalPagesAdmin.NewEquipmentApplications" %>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Содержание" Visible="True">
                    <ItemTemplate>
