<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="NewWebCourseApplications.aspx.cs" Inherits="KPIWeb.PersonalPagesAdmin.NewWebCourseApplications" %>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Информация о курсе" Visible="True">
                    <ItemTemplate>
