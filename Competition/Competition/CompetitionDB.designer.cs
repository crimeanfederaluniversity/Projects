...
namespace Competition
{
    ...
    partial void DeleteUser_BidMapingTable(User_BidMapingTable instance);
		...
		public CompetitionDBDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["KonkursyConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
...
<<<<<<< .mine
		public System.Data.Linq.Table<AutoFilling> AutoFillings
=======
...
<<<<<<< .mine
		public System.Data.Linq.Table<Konkursy> Konkursies
=======
...
>>>>>>> .r382
		...
		public System.Data.Linq.Table<Smeta> Smetas
		{
			get
			{
...
<<<<<<< .mine
		public System.Data.Linq.Table<SmetaValue> SmetaValues
=======
...
>>>>>>> .r382
		...
		public System.Data.Linq.Table<User_BidMapingTable> User_BidMapingTables
		{
			get
			{
			...
			set
			{
							...
							|| (this._Konkursy.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.AutoFillings.Remove(this);
					}
					this._Konkursy.Entity = value;
					if ((value != null))
					{
						value.AutoFillings.Add(this);
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Konkursy> _Konkursies;
		
		private EntitySet<User_BidMapingTable> _User_BidMapingTables;
    ...
    partial void OnActiveChanged();
		...
		public User()
		{
			this._Konkursies = new EntitySet<Konkursy>(new Action<Konkursy>(this.attach_Konkursies), new Action<Konkursy>(this.detach_Konkursies));
			this._User_BidMapingTables = new EntitySet<User_BidMapingTable>(new Action<User_BidMapingTable>(this.attach_User_BidMapingTables), new Action<User_BidMapingTable>(this.detach_User_BidMapingTables));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Konkursy", Storage="_Konkursies", ThisKey="ID_User", OtherKey="FK_Curator")]
		public EntitySet<Konkursy> Konkursies
		{
			get
			{
				return this._Konkursies;
			}
			set
			{
				this._Konkursies.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_User_BidMapingTable", Storage="_User_BidMapingTables", ThisKey="ID_User", OtherKey="FK_User")]
		public EntitySet<User_BidMapingTable> User_BidMapingTables
		{
			get
			{
				return this._User_BidMapingTables;
			}
			set
			{
				this._User_BidMapingTables.Assign(value);
			}
		}
		...
		private void attach_Konkursies(Konkursy entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_Konkursies(Konkursy entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
		
		private void attach_User_BidMapingTables(User_BidMapingTable entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_User_BidMapingTables(User_BidMapingTable entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
...
<<<<<<< .mine
		private EntitySet<SmetaValue> _SmetaValues;
=======
...
>>>>>>> .r382
    ...
    partial void OnComentChanged();
		...
		{
<<<<<<< .mine
			this._SmetaValues = new EntitySet<SmetaValue>(new Action<SmetaValue>(this.attach_SmetaValues), new Action<SmetaValue>(this.detach_SmetaValues));
			this._User_BidMapingTables = new EntitySet<User_BidMapingTable>(new Action<User_BidMapingTable>(this.attach_User_BidMapingTables), new Action<User_BidMapingTable>(this.detach_User_BidMapingTables));
=======
...
<<<<<<< .mine
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bid_SmetaValue", Storage="_SmetaValues", ThisKey="ID_Bid", OtherKey="FK_Bid")]
		public EntitySet<SmetaValue> SmetaValues
=======
...
>>>>>>> .r382
		{
			get
			{
				return this._SmetaValues;
			}
			set
			{
				this._SmetaValues.Assign(value);
			}
		}
		
<<<<<<< .mine
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bid_User_BidMapingTable", Storage="_User_BidMapingTables", ThisKey="ID_Bid", OtherKey="FK_Bid")]
		public EntitySet<User_BidMapingTable> User_BidMapingTables
=======
...
>>>>>>> .r382
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Konkursy_Bid", Storage="_Konkursy", ThisKey="FK_Konkurs", OtherKey="ID_Konkurs", IsForeignKey=true)]
		public Konkursy Konkursy
		{
			get
			{
...
<<<<<<< .mine
		private void attach_SmetaValues(SmetaValue entity)
=======
...
>>>>>>> .r382
		...
		private void detach_SmetaValues(SmetaValue entity)
		{
			this.SendPropertyChanging();
			entity.Bid = null;
		}
...
>>>>>>> .r382
	...
	public partial class Konkursy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AutoFilling> _AutoFillings;
		
		private EntitySet<Bid> _Bids;
		
<<<<<<< .mine
		private EntitySet<Smeta> _Smetas;
=======
...
>>>>>>> .r382
    ...
    partial void OnActiveChanged();
		...
		{
<<<<<<< .mine
			this._AutoFillings = new EntitySet<AutoFilling>(new Action<AutoFilling>(this.attach_AutoFillings), new Action<AutoFilling>(this.detach_AutoFillings));
			this._Bids = new EntitySet<Bid>(new Action<Bid>(this.attach_Bids), new Action<Bid>(this.detach_Bids));
			this._Smetas = new EntitySet<Smeta>(new Action<Smeta>(this.attach_Smetas), new Action<Smeta>(this.detach_Smetas));
...
>>>>>>> .r382
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Konkursy_AutoFilling", Storage="_AutoFillings", ThisKey="ID_Konkurs", OtherKey="FK_Konkurs")]
		public EntitySet<AutoFilling> AutoFillings
		{
			get
			{
				return this._AutoFillings;
			}
			set
			{
				this._AutoFillings.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Konkursy_Bid", Storage="_Bids", ThisKey="ID_Konkurs", OtherKey="FK_Konkurs")]
...
<<<<<<< .mine
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Konkursy_Smeta", Storage="_Smetas", ThisKey="ID_Konkurs", OtherKey="FK_Konkurs")]
		public EntitySet<Smeta> Smetas
=======
...
>>>>>>> .r382
		{
			...
			set
			{
				this._Smetas.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Konkursy", Storage="_User", ThisKey="FK_Curator", OtherKey="ID_User", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Konkursies.Remove(this);
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.Konkursies.Add(this);
		...
		private void attach_AutoFillings(AutoFilling entity)
		{
			this.SendPropertyChanging();
			entity.Konkursy = this;
		}
		
		private void detach_AutoFillings(AutoFilling entity)
		{
			this.SendPropertyChanging();
...
<<<<<<< .mine
		private void attach_Smetas(Smeta entity)
=======
...
>>>>>>> .r382
		...
		private void detach_Smetas(Smeta entity)
		{
			this.SendPropertyChanging();
			entity.Konkursy = null;
		}
    ...
    partial void OnActiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Smeta_SmetaValue", Storage="_SmetaValues", ThisKey="ID_State", OtherKey="FK_State")]
		public EntitySet<SmetaValue> SmetaValues
		{
			get
			{
		...
		public Konkursy Konkursy
		{
			...
			set
			{
							...
							|| (this._Konkursy.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Konkursy.Entity = null;
						previousValue.Smetas.Remove(this);
					}
					this._Konkursy.Entity = value;
					if ((value != null))
					{
						value.Smetas.Add(this);
						this._FK_Konkurs = value.ID_Konkurs;
					}
					else
					{
    ...
    partial void OnValueChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bid_SmetaValue", Storage="_Bid", ThisKey="FK_Bid", OtherKey="ID_Bid", IsForeignKey=true)]
		public Bid Bid
		{
			get
			{
			...
			set
			{
							...
							|| (this._Bid.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.SmetaValues.Remove(this);
					}
					this._Bid.Entity = value;
					if ((value != null))
					{
						value.SmetaValues.Add(this);
						this._FK_Bid = value.ID_Bid;
					}
					else
					{
    ...
    partial void OnActiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bid_User_BidMapingTable", Storage="_Bid", ThisKey="FK_Bid", OtherKey="ID_Bid", IsForeignKey=true)]
		public Bid Bid
		{
			get
			{
			...
			set
			{
							...
							|| (this._Bid.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Bid.Entity = null;
						previousValue.User_BidMapingTables.Remove(this);
					}
					this._Bid.Entity = value;
					if ((value != null))
					{
						value.User_BidMapingTables.Add(this);
						this._FK_Bid = value.ID_Bid;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_User_BidMapingTable", Storage="_User", ThisKey="FK_User", OtherKey="ID_User", IsForeignKey=true)]
		public User User
		{
			get
			{
