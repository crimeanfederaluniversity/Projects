...
namespace EDM.edm
{
    public partial class ProcessEdit : System.Web.UI.Page
    {
        ...
        public TreeView GetTreeViewWithPepole(int rowId, int mainNodeId)
        {
            ...
            strucTreeView.Nodes.Add(GetStructTreeViewNode("ctl00_MainContent_chooseUserPanel" + rowId, "ctl00_MainContent_ParticipentNameTextBox" + rowId, "ctl00_MainContent_ParticipentIdTextBox" + rowId, false, mainNodeId));
        ...
        public Table GetSearchResults(string searchText, int rowId)
        {
            ...
            foreach (Users user in users)
            {
                ...
                chooseButton.OnClientClick = "document.getElementById('ctl00_MainContent_ParticipentIdTextBox" + rowId.ToString() + "').value = " + user.userID + "; " +
                                             "document.getElementById('ctl00_MainContent_ParticipentNameTextBox" + rowId.ToString() + "').value = '" + user.name + " " + user.@struct + "'; " +
                                             "document.getElementById('ctl00_MainContent_chooseUserPanel" + rowId + "').style.visibility = 'hidden';  return false; ";
        ...
        public Table GetNewParticipantsTable(bool canEdit)
        {
            ...
            if (participantsCount != 0)
            {
                ...
                for (int i = 0; i < participantsCount; i++)
                {
                    ...
                    endDateCheckBox.Attributes.Add("onclick", "toggle_visibility('ctl00_MainContent_" + ParticipantsList[i].ParticipantEndDateTextBox.ID + "')");
