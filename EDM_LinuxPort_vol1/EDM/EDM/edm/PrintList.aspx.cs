...
namespace EDM.edm
{
    public partial class PrintList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int portProcId = of.GetProcMaxVersion(processId);
            var documentsInProc = (from a in _edmDb.ProcVersionDocsMap
                where a.active == true && a.fk_processVersion == portProcId
            ...
            initiatorNameLabel.Text = "Исполнитель: " + _edmDb.Users.Where(u => u.userID == proc.fk_initiator && u.active == true).Select(u => u.name).FirstOrDefault();
