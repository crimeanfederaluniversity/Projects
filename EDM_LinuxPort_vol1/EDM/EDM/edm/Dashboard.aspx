...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" id="fixedPanelNewSub" class="innerSubmitionFixed">
        ...
        <asp:Button ID="cancelSubProcessButton" Width="300" Height="30" runat="server" Text="Отмена" OnClientClick="document.getElementById('ctl00_MainContent_fixedPanelNewSub').style.visibility='hidden';  return false;" />
        </div>
    <br/><br/>
