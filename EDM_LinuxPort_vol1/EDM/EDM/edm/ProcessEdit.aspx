...
<br />
    ...
    <script>
        ...
        {
            if (document.getElementById('ctl00_MainContent_ProcessNameTextBox').value.length < 1)
            {
                alert('Введите название нового согласования');
                return false;
            }
            if (document.getElementById('ctl00_MainContent_ParticipantsCountTextBox').value.length < 1)
            {
        ...
        {
            if (document.getElementById('ctl00_MainContent_ProcessNameT').value.length < 1) {
                alert('Введите название нового согласования');
                return false;
            }
            return true;
    ...
    <table class="table table-striped edm-table edm-PocessEdit-table centered-block">
        ...
        <tr runat="server" id="CustomProcessCreateRow">
		   <td>
            ...
            <td>
                <asp:TextBox ID="ParticipantsCountTextBox" runat="server" CssClass="form-control"></asp:TextBox>
