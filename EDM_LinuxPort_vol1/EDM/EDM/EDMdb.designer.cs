...
namespace EDM
{
    ...
    partial void InsertProcessCharacter(ProcessCharacter instance);
    partial void UpdateProcessCharacter(ProcessCharacter instance);
    partial void DeleteProcessCharacter(ProcessCharacter instance);
    ...
    partial void InsertProcessStarterUser(ProcessStarterUser instance);
    partial void UpdateProcessStarterUser(ProcessStarterUser instance);
    partial void DeleteProcessStarterUser(ProcessStarterUser instance);
    ...
    partial void DeleteSubmitters(Submitters instance);
		...
		public System.Data.Linq.Table<ProcessCharacter> ProcessCharacter
		{
			get
			{
				return this.GetTable<ProcessCharacter>();
			}
		}
		...
		public System.Data.Linq.Table<ProcessStarterUser> ProcessStarterUser
		{
			get
			{
				return this.GetTable<ProcessStarterUser>();
			}
		}
	...
	public partial class Users : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ProcessStarterUser> _ProcessStarterUser;
    ...
    partial void OnsexChanged();
		...
		public Users()
		{
			...
			this._ProcessStarterUser = new EntitySet<ProcessStarterUser>(new Action<ProcessStarterUser>(this.attach_ProcessStarterUser), new Action<ProcessStarterUser>(this.detach_ProcessStarterUser));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Users_ProcessStarterUser", Storage="_ProcessStarterUser", ThisKey="userID", OtherKey="fk_user")]
		public EntitySet<ProcessStarterUser> ProcessStarterUser
		{
			get
			{
				return this._ProcessStarterUser;
			}
			set
			{
				this._ProcessStarterUser.Assign(value);
			}
		}
		...
		private void attach_ProcessStarterUser(ProcessStarterUser entity)
		{
			this.SendPropertyChanging();
			entity.Users = this;
		}
		
		private void detach_ProcessStarterUser(ProcessStarterUser entity)
		{
			this.SendPropertyChanging();
			entity.Users = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ProcessCharacter")]
	public partial class ProcessCharacter : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _processCharacterId;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnprocessCharacterIdChanging(int value);
    partial void OnprocessCharacterIdChanged();
    partial void OnactiveChanging(bool value);
    partial void OnactiveChanged();
    partial void OnnameChanging(string value);
    partial void OnnameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_processCharacterId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int processCharacterId
		{
			get
			{
				return this._processCharacterId;
			}
			set
			{
				if ((this._processCharacterId != value))
				{
					this.OnprocessCharacterIdChanging(value);
					this.SendPropertyChanging();
					this._processCharacterId = value;
					this.SendPropertyChanged("processCharacterId");
					this.OnprocessCharacterIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProcessCharacter_Processes", Storage="_Processes", ThisKey="processCharacterId", OtherKey="fk_processCharacter")]
		public EntitySet<Processes> Processes
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProcessCharacter_ProcessTemplate", Storage="_ProcessTemplate", ThisKey="processCharacterId", OtherKey="fk_processCharacter")]
		public EntitySet<ProcessTemplate> ProcessTemplate
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.ProcessCharacter = this;
		}
		
		private void detach_Processes(Processes entity)
		{
			this.SendPropertyChanging();
			entity.ProcessCharacter = null;
		}
	...
	public partial class Processes : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _fk_processCharacter;
		...
		private EntityRef<ProcessCharacter> _ProcessCharacter;
    ...
    partial void Onfk_processCharacterChanging(System.Nullable<int> value);
    partial void Onfk_processCharacterChanged();
    #endregion
		...
		public Processes()
		{
			...
			this._ProcessCharacter = default(EntityRef<ProcessCharacter>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_fk_submitter", DbType="Int")]
		public System.Nullable<int> fk_submitter
		{
			get
			{
				return this._fk_submitter;
			}
			set
			{
				if ((this._fk_submitter != value))
				{
					if (this._Submitters.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.Onfk_submitterChanging(value);
					this.SendPropertyChanging();
					this._fk_submitter = value;
					this.SendPropertyChanged("fk_submitter");
					this.Onfk_submitterChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_fk_processCharacter", DbType="Int")]
		public System.Nullable<int> fk_processCharacter
		{
			get
			{
				return this._fk_processCharacter;
			}
			set
			{
				if ((this._fk_processCharacter != value))
				{
					if (this._ProcessCharacter.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.Onfk_processCharacterChanging(value);
					this.SendPropertyChanging();
					this._fk_processCharacter = value;
					this.SendPropertyChanged("fk_processCharacter");
					this.Onfk_processCharacterChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProcessCharacter_Processes", Storage="_ProcessCharacter", ThisKey="fk_processCharacter", OtherKey="processCharacterId", IsForeignKey=true)]
		public ProcessCharacter ProcessCharacter
		{
			get
			{
				return this._ProcessCharacter.Entity;
			}
			set
			{
				ProcessCharacter previousValue = this._ProcessCharacter.Entity;
				if (((previousValue != value) 
							|| (this._ProcessCharacter.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ProcessCharacter.Entity = null;
						previousValue.Processes.Remove(this);
					}
					this._ProcessCharacter.Entity = value;
					if ((value != null))
					{
						value.Processes.Add(this);
						this._fk_processCharacter = value.processCharacterId;
					}
					else
					{
						this._fk_processCharacter = default(Nullable<int>);
					}
					this.SendPropertyChanged("ProcessCharacter");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ProcessStarterUser")]
	public partial class ProcessStarterUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _processStarterUserId;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnprocessStarterUserIdChanging(int value);
    partial void OnprocessStarterUserIdChanged();
    partial void OnactiveChanging(bool value);
    partial void OnactiveChanged();
    partial void Onfk_userChanging(int value);
    partial void Onfk_userChanged();
    ...
    partial void Onfk_structChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_processStarterUserId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int processStarterUserId
		{
			get
			{
				return this._processStarterUserId;
			}
			set
			{
				if ((this._processStarterUserId != value))
				{
					this.OnprocessStarterUserIdChanging(value);
					this.SendPropertyChanging();
					this._processStarterUserId = value;
					this.SendPropertyChanged("processStarterUserId");
					this.OnprocessStarterUserIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Users_ProcessStarterUser", Storage="_Users", ThisKey="fk_user", OtherKey="userID", IsForeignKey=true)]
		public Users Users
		{
			get
			{
			...
			set
			{
							...
							|| (this._Users.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Users.Entity = null;
						previousValue.ProcessStarterUser.Remove(this);
					}
					this._Users.Entity = value;
					if ((value != null))
					{
						value.ProcessStarterUser.Add(this);
						this._fk_user = value.userID;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Struct_ProcessStarterUser", Storage="_Struct", ThisKey="fk_struct", OtherKey="structID", IsForeignKey=true)]
    ...
    partial void Onfk_processCharacterChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProcessCharacter_ProcessTemplate", Storage="_ProcessCharacter", ThisKey="fk_processCharacter", OtherKey="processCharacterId", IsForeignKey=true)]
		public ProcessCharacter ProcessCharacter
		{
			get
			{
    ...
    partial void Onfk_parentChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Struct_ProcessStarterUser", Storage="_ProcessStarterUser", ThisKey="structID", OtherKey="fk_struct")]
		public EntitySet<ProcessStarterUser> ProcessStarterUser
		{
			get
			{
