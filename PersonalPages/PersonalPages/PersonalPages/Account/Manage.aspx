<%@ Page Title="Управление учетной записью" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="PersonalPages.Account.Manage" %>
        ...
        <div class="col-md-12">
            <section id="passwordForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="confirmPassword"
                                    CssClass="text-error" Display="Dynamic" ErrorMessage="Пароль и его подтверждение не совпадают."
                                    ValidationGroup="SetPassword" />
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>Выполнен вход: <strong><%: User.Identity.GetUserName() %></strong>.</p>
                    <div class="form-horizontal">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" Text="Удалить" CommandName="Delete" CausesValidation="false"
                                    ToolTip='<%# "Удалите эту учетную запись " + Item.LoginProvider + " у себя" %>'
