<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateContractPage.aspx.cs" Inherits="Zakupka.Event.CreateContractPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <h3>Cоздание нового договора:</h3>Введите название договора: 
    <p>
