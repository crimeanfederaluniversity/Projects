...
<div id="sidePanel" class='side_legend' onclick="legendChange()"> 
    <div id="img_of_sp" class="side_img_legend"></div>   
            ...
            O</button>-->
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label7" runat="server" Text="Ëåãåíäà" ValidateRequestMode="Enabled"></asp:Label>
            <br />
            <br />
            <asp:Panel ID="Panel5" runat="server" CssClass="ColorPanelLegend">
                <asp:Label ID="Label11" runat="server" Text="........Óòâåðæäåíî"></asp:Label>
                <br />
            </asp:Panel>
            <br />
            <asp:Panel ID="Panel6" runat="server" Height="17" BackColor="#000099" BorderColor="#000099">
                <asp:Label ID="Label12" runat="server" Text=".......Òðåáóåò Âàøåãî óòâåðæäåíèÿ"></asp:Label>
            </asp:Panel>
            <br />
            <asp:Panel ID="Panel7" runat="server" Height="17" BackColor="#CC0000" BorderColor="#CC0000">
                <asp:Label ID="Label13" runat="server" style="text-align: center" Text="....Ðàññ÷èòàíî ïî íåïîëíûì äàííûì"></asp:Label>
            </asp:Panel>
        </div>  
<div id="comment_Section" class='commentSectionStyle'> 
            <h4 style="text-align:center"> Ïîñëå óòâåðæäåíèÿ äàííûõ èõ èçìåíåíèå áóäåò íåâîçìîæíî! </h4>  
            <h4 style="margin-left:5px"> Êîììåíòàðèé ê óòâåðæäàåìîìó çíà÷åíèþ:</h4>
    
            <asp:TextBox ID="TextBox1" runat="server"  CssClass="commentTextBox" TextMode="MultiLine" ></asp:TextBox>
            <button type="button"  class="commentLeftButton" onclick="closeCommentSection()">Îòìåíà</button>
            <button type="button" class="commentRightButton"  onclick="commentSendButtonClick()">Óòâåðäèòü</button>
        </div>
