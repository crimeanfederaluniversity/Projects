...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Мои конкурсы" Width="410px" />
    <br />
    <asp:Button ID="Button1" runat="server" Text="Заявки, к моим конкурсам" OnClick="Button1_Click" Width="412px" />
</asp:Content>
