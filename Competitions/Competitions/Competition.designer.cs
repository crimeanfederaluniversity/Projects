...
namespace Competitions
{
    ...
    partial void DeletezColumnTable(zColumnTable instance);
		...
		public CompetitionDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CompetitionsDBConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnAccessLevelChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UsersTable_zExpertsAndApplicationMappingTable", Storage="_zExpertsAndApplicationMappingTables", ThisKey="ID", OtherKey="FK_UsersTable")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UsersTable_zExpertPointsValue", Storage="_zExpertPointsValues", ThisKey="ID", OtherKey="FK_ExpertsTable")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UsersTable_zApplicationTable", Storage="_zApplicationTables", ThisKey="ID", OtherKey="FK_UsersTable")]
    ...
    partial void OnActiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="zExpertPoint_zExpertPointsValue", Storage="_zExpertPointsValues", ThisKey="ID", OtherKey="FK_ExpertsTable")]
		public EntitySet<zExpertPointsValue> zExpertPointsValues
		{
			get
			{
    ...
    partial void OnLastChangeDataTimeChanged();
		...
		public System.Nullable<int> FK_ExpertsTable
		{
			...
			set
			{
				...
				{
					if ((this._UsersTable.HasLoadedOrAssignedValue || this._zExpertPoint.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="zExpertPoint_zExpertPointsValue", Storage="_zExpertPoint", ThisKey="FK_ExpertsTable", OtherKey="ID", IsForeignKey=true)]
