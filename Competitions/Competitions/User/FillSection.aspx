               ...
               <Columns>         
                     ...
                     <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox0"        runat="server"  Visible='<%# Bind("EditTextBoxVisible0") %>'         Text='<%# Bind("EditTextBoxValue0") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox1"        runat="server"  Visible='<%# Bind("EditTextBoxVisible1") %>'         Text='<%# Bind("EditTextBoxValue1") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox2"        runat="server"  Visible='<%# Bind("EditTextBoxVisible2") %>'         Text='<%# Bind("EditTextBoxValue2") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox3"        runat="server"  Visible='<%# Bind("EditTextBoxVisible3") %>'         Text='<%# Bind("EditTextBoxValue3") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox4"        runat="server"  Visible='<%# Bind("EditTextBoxVisible4") %>'         Text='<%# Bind("EditTextBoxValue4") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox5"        runat="server"  Visible='<%# Bind("EditTextBoxVisible5") %>'         Text='<%# Bind("EditTextBoxValue5") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox6"        runat="server"  Visible='<%# Bind("EditTextBoxVisible6") %>'         Text='<%# Bind("EditTextBoxValue6") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox7"        runat="server"  Visible='<%# Bind("EditTextBoxVisible7") %>'         Text='<%# Bind("EditTextBoxValue7") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox8"        runat="server"  Visible='<%# Bind("EditTextBoxVisible8") %>'         Text='<%# Bind("EditTextBoxValue8") %>'                ></asp:TextBox>                                                   
                    ...
                    <asp:TemplateField Visible="false"   HeaderText="Значение">
                        <ItemTemplate >
                            ...
                            <asp:TextBox        ID="EditTextBox9"        runat="server"  Visible='<%# Bind("EditTextBoxVisible9") %>'         Text='<%# Bind("EditTextBoxValue9") %>'                ></asp:TextBox>                                                   
