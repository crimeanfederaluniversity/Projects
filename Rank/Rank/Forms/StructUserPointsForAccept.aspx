<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation ="false" CodeBehind="StructUserPointsForAccept.aspx.cs" Inherits="Rank.Forms.StructUserPointsForAccept" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h3>Результаты сотрудников Вашего структурного подразделения для показателя
