...
namespace Rank
{
    ...
    partial void OnFK_dropdownChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Rank_DropDownValues_Rank_ArticleValues", Storage="_Rank_ArticleValues", ThisKey="ID", OtherKey="FK_dropvalue")]
		public EntitySet<Rank_ArticleValues> Rank_ArticleValues
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.Rank_DropDownValues = this;
		}
		
		private void detach_Rank_ArticleValues(Rank_ArticleValues entity)
		{
			this.SendPropertyChanging();
			entity.Rank_DropDownValues = null;
		}
	}
	...
	public partial class Rank_ArticleValues : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _FK_dropvalue;
		
		private EntityRef<Rank_Articles> _Rank_Articles;
		
		private EntityRef<Rank_DropDownValues> _Rank_DropDownValues;
    ...
    partial void OnFK_dropvalueChanging(System.Nullable<int> value);
    partial void OnFK_dropvalueChanged();
    #endregion
		
		public Rank_ArticleValues()
		{
			this._Rank_Articles = default(EntityRef<Rank_Articles>);
			this._Rank_DropDownValues = default(EntityRef<Rank_DropDownValues>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FK_dropvalue", DbType="Int")]
		public System.Nullable<int> FK_dropvalue
		{
			get
			{
				return this._FK_dropvalue;
			}
			set
			{
				if ((this._FK_dropvalue != value))
				{
					if (this._Rank_DropDownValues.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnFK_dropvalueChanging(value);
					this.SendPropertyChanging();
					this._FK_dropvalue = value;
					this.SendPropertyChanged("FK_dropvalue");
					this.OnFK_dropvalueChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Rank_DropDownValues_Rank_ArticleValues", Storage="_Rank_DropDownValues", ThisKey="FK_dropvalue", OtherKey="ID", IsForeignKey=true)]
		public Rank_DropDownValues Rank_DropDownValues
		{
			get
			{
				return this._Rank_DropDownValues.Entity;
			}
			set
			{
				Rank_DropDownValues previousValue = this._Rank_DropDownValues.Entity;
				if (((previousValue != value) 
							|| (this._Rank_DropDownValues.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Rank_DropDownValues.Entity = null;
						previousValue.Rank_ArticleValues.Remove(this);
					}
					this._Rank_DropDownValues.Entity = value;
					if ((value != null))
					{
						value.Rank_ArticleValues.Add(this);
						this._FK_dropvalue = value.ID;
					}
					else
					{
						this._FK_dropvalue = default(Nullable<int>);
					}
					this.SendPropertyChanged("Rank_DropDownValues");
				}
			}
		}
