<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/Site.Master"  CodeBehind="DCheckedInfo.aspx.cs" Inherits="KPIWeb.Director.DCheckedInfo" %>
...
background-color:#FFFFFF}
    ...
    <h2>Параметры направлений подготовки</h2>
     ...
     <asp:GridView ID="GridView1" runat="server" 
            ...
            style="margin-top: 0px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
             <Columns>  
