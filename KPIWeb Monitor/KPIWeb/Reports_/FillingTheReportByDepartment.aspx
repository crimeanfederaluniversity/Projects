<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FillingTheReportByDepartment.aspx.cs" Inherits="KPIWeb.DepartmentFilling.FillingReport" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">  
    ...
    <asp:GridView ID="GridviewCollectedBasicParameters"  BorderStyle="Solid" runat="server"  ShowFooter="true" AutoGenerateColumns="False" 
                ...
                OnRowDataBound="GridviewCollectedBasicParameters_RowDataBound" Height="271px" Width="708px" >
               <Columns>    
                               
                    <asp:BoundField DataField="Struct1" HeaderText="Структурное подразделение" Visible="true" />
                    <asp:BoundField DataField="Struct2" HeaderText="Структурное подразделение" Visible="true" /> 
                    <asp:BoundField DataField="Struct3" HeaderText="Структурное подразделение" Visible="true" />
