<%@ Page Title="Register an external login" Language="C#" EnableViewStateMac="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="KPIWeb.Account.RegisterExternalLogin" Async="true" %>
