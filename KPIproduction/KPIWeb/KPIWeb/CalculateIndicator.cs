        ...
        public static double? Calculate(int IndicatorsTableID, int ReportArchiveTableID)
        {
            ...
            switch (IndicatorsTableID)
            {
                ...
                case 2:
                    ...
                    double? SBB_EG = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                      item.FK_BasicParametersTable == 108
                                      select item.CollectedValue).Sum();

                    double? SBB_EG_DI = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                         where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                         item.FK_BasicParametersTable == 109
                                         select item.CollectedValue).Sum();

                    double? ChB_EG_DI = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                         where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                         item.FK_BasicParametersTable == 113
                                         select item.CollectedValue).Sum();

                    double? ChB_EG = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                      item.FK_BasicParametersTable == 112
                                      select item.CollectedValue).Sum();
                    double? ChS_EG = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                      item.FK_BasicParametersTable == 119
                                      select item.CollectedValue).Sum();
                    double? ChS_EG_DI = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                         where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 3:
                    ...
                    double? a_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                          where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                          item.FK_BasicParametersTable == 16
                                          select item.CollectedValue).Sum();

                    double? b_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                          where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                          item.FK_BasicParametersTable == 23
                                          select item.CollectedValue).Sum();

                    double? c_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                          where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                          item.FK_BasicParametersTable == 30
                                          select item.CollectedValue).Sum();

                    double? d_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                          where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                    ...
                    a_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                  where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                  item.FK_BasicParametersTable == 2
                                  select item.CollectedValue).Sum();

                    b_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                  where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                  item.FK_BasicParametersTable == 5
                                  select item.CollectedValue).Sum();

                    c_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                  where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                  item.FK_BasicParametersTable == 8
                                  select item.CollectedValue).Sum();

                    d_M_dvo_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                  where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 4:
                    double? a_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                             where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                             item.FK_BasicParametersTable == 65
                                             select item.CollectedValue).Sum();

                    double? b_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                             where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                             item.FK_BasicParametersTable == 71
                                             select item.CollectedValue).Sum();

                    double? c_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                             where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                             item.FK_BasicParametersTable == 77
                                             select item.CollectedValue).Sum();

                    double? d_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                             where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                    ...
                    a_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                     item.FK_BasicParametersTable == 43
                                     select item.CollectedValue).Sum();

                    b_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                     item.FK_BasicParametersTable == 48
                                     select item.CollectedValue).Sum();

                    c_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                     item.FK_BasicParametersTable == 53
                                     select item.CollectedValue).Sum();

                    d_B_dco_pk_oz = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 5:
                    ...
                    double? SCHNPR = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                      item.FK_BasicParametersTable == 1
                                      select item.CollectedValue).Sum();

                    double? CHS_PPS_sh = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                          where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                          item.FK_BasicParametersTable == 124
                                          select item.CollectedValue).Sum();

                    double? CHS_PPS_vnsm = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                            where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                            item.FK_BasicParametersTable == 123
                                            select item.CollectedValue).Sum();

                    double? CHS_NR_sh = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                         where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                         item.FK_BasicParametersTable == 122
                                         select item.CollectedValue).Sum();

                    double? CHS_NR_vnsm = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                           where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 6:
                    ...
                    double? KP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                  where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                  item.FK_BasicParametersTable == 96
                                  select item.CollectedValue).Sum();

                    SCHNPR = (from item in KPIWebDataContext.CollectedBasicParametersTables
                              where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                              item.FK_BasicParametersTable == 1
                              select item.CollectedValue).Sum();

                    CHS_PPS_sh = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                  where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                  item.FK_BasicParametersTable == 124
                                  select item.CollectedValue).Sum();

                    CHS_PPS_vnsm = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                    where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                    item.FK_BasicParametersTable == 123
                                    select item.CollectedValue).Sum();

                    CHS_NR_sh = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                 where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                 item.FK_BasicParametersTable == 122
                                 select item.CollectedValue).Sum();

                    CHS_NR_vnsm = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                   where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                   item.FK_BasicParametersTable == 121
                                   select item.CollectedValue).Sum();
                ...
                case 7:
                    ...
                    double? KPS5 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                    where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 8:
                    double? NYOKR = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 9:
                    ...
                    double? a_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 62
                                        select item.CollectedValue).Sum();

                    double? b_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 68
                                        select item.CollectedValue).Sum();

                    double? c_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 74
                                        select item.CollectedValue).Sum();

                    double? d_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                    ...
                    a_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                item.FK_BasicParametersTable == 45
                                select item.CollectedValue).Sum();

                    b_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                item.FK_BasicParametersTable == 50
                                select item.CollectedValue).Sum();

                    c_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                item.FK_BasicParametersTable == 55
                                select item.CollectedValue).Sum();

                    d_YSB_pr = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 10:
                    ...
                    returnValue = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                   where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 11:
                    double? OOS = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                   where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                   item.FK_BasicParametersTable == 104
                                   select item.CollectedValue).Sum();
                    double? OS_VNB = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 12:
                    ...
                    OOS = (from item in KPIWebDataContext.CollectedBasicParametersTables
                           where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                           item.FK_BasicParametersTable == 104
                           select item.CollectedValue).Sum();
                    SCHNPR = (from item in KPIWebDataContext.CollectedBasicParametersTables
                ...
                case 13:
                    OS_VNB = (from item in KPIWebDataContext.CollectedBasicParametersTables
                              where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                    ...
                    double? SZP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                   where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                   item.FK_BasicParametersTable == 124
                                   select item.CollectedValue).Sum();
                ...
                case 14:
                    ...
                    double? b_OOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                     item.FK_BasicParametersTable == 100
                                     select item.CollectedValue).Sum();

                    double? d_OOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                     item.FK_BasicParametersTable == 101
                                     select item.CollectedValue).Sum();

                    double? m_OOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                     item.FK_BasicParametersTable == 102
                                     select item.CollectedValue).Sum();

                    double? s_OOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                    ...
                    double? b_CHOOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 115
                                       select item.CollectedValue).Sum();

                    double? d_CHOOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 116
                                       select item.CollectedValue).Sum();

                    double? m_CHOOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 117
                                       select item.CollectedValue).Sum();

                    double? s_CHOOP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 15:
                    double? b_OP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                    where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                    item.FK_BasicParametersTable == 89
                                    select item.CollectedValue).Sum();

                    double? s_OP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                    where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                    item.FK_BasicParametersTable == 91
                                    select item.CollectedValue).Sum();

                    double? m_OP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                    where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                    item.FK_BasicParametersTable == 90
                                    select item.CollectedValue).Sum();

                    double? d_OP = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                    where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 16:
                    ...
                    double? OOP_100 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 100
                                       select item.CollectedValue).Sum();

                    double? OOP_103 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 103
                                       select item.CollectedValue).Sum();

                    double? OOP_102 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 102
                                       select item.CollectedValue).Sum();

                    double? OOP_101 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                       where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                       item.FK_BasicParametersTable == 101
                                       select item.CollectedValue).Sum();
                    ...
                    OOP_100 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                               where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                               item.FK_BasicParametersTable == 115
                               select item.CollectedValue).Sum();

                    OOP_103 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                               where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                               item.FK_BasicParametersTable == 118
                               select item.CollectedValue).Sum();

                    OOP_102 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                               where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                               item.FK_BasicParametersTable == 117
                               select item.CollectedValue).Sum();

                    OOP_101 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                               where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                               item.FK_BasicParametersTable == 116
                               select item.CollectedValue).Sum();
                ...
                case 17:
                    ...
                    double? KP_65 = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                     where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 18:
                    ...
                    double? kol_MM = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 19:
                    ...
                    double? PK_NPR = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                      where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                ...
                case 20:
                    ...
                    //Б_Р_пк 
                    double? a_B_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 64
                                        select item.CollectedValue).Sum();

                    double? b_B_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 70
                                        select item.CollectedValue).Sum();

                    double? c_B_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 76
                                        select item.CollectedValue).Sum();

                    double? d_B_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                    ...
                    double? a_M_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 20
                                        select item.CollectedValue).Sum();

                    double? b_M_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 20
                                        select item.CollectedValue).Sum();

                    double? c_M_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 20
                                        select item.CollectedValue).Sum();

                    double? d_M_R_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 20
                                        select item.CollectedValue).Sum();
                    ...
                    double? a_A_P_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 3
                                        select item.CollectedValue).Sum();

                    double? b_A_P_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 6
                                        select item.CollectedValue).Sum();

                    double? c_A_P_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
                                        item.FK_BasicParametersTable == 9
                                        select item.CollectedValue).Sum();

                    double? d_A_P_pk = (from item in KPIWebDataContext.CollectedBasicParametersTables
                                        where item.FK_ReportArchiveTable == ReportArchiveTableID &&
