        ...
        <div>
            ...
            <asp:GridView ID="GridviewCollectedBasicParameters" BorderStyle="Solid" runat="server" ShowFooter="true" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BasicParametersTableID" HeaderText="Номер показателя" Visible="true" />
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Экспорт в excel" Width="400px" />
