...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">   
    ...
    <div id="all_menu_Wrapper">
        <asp:Label ID="Label1" runat="server" Text="Сетевое взаимодействие и повышение квалификации на базе партнерских организаций"></asp:Label>
          <div id="all_menu">
                <div id="left_side">
                    <asp:HyperLink ID="Button125" runat="server" NavigateUrl="/Rector/ImageShower.aspx?url=NewInt/NetworkCommunicationStuff/ObrProg_1.png">  Создание образовательных программ с использованием сетевой формы, в том числе в рамках сети федеральных университетов </asp:HyperLink>
      </div>
                    <div id="right_side">
                         <asp:HyperLink ID="Button126" runat="server" NavigateUrl="/Rector/ImageShower.aspx?url=NewInt/NetworkCommunicationStuff/stimul_1.png"> Стимулирование академической мобильности работников университета и обучающихся в университете </asp:HyperLink>
        <br />
       </div>
              </div>
               <div id="wrapapiu_bot_but">
                  
        <asp:HyperLink ID="Button127" runat="server" NavigateUrl="/Rector/ImageShower.aspx?url=NewInt/NetworkCommunicationStuff/Clenstvo_1.png"> Членство в ассоциациях и объединениях научно-образовательных организаций </asp:HyperLink>
