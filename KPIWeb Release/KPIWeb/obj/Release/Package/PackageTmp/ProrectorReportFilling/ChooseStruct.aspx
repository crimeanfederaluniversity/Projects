<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChooseStruct.aspx.cs" Inherits="KPIWeb.ProrectorReportFilling.ChooseStruct" %>
        ...
        <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False"  style="margin-top: 0px">
             <Columns>                              
                 ...
                 <asp:BoundField DataField="Status" HeaderText="Статус данных" Visible="True" />
                  <asp:TemplateField HeaderText="Перейти к редактированию">
                        <ItemTemplate>
                            <asp:Button ID="ButtonOpenFillingPage" runat="server" OnClientClick="showLoadPanel()" CommandName="Select" Text="Перейти" Width="200px" CommandArgument='<%# Eval("StructID") %>' OnClick="ButtonOpenFillingPageClick"/>
                        </ItemTemplate>
                    </asp:TemplateField>                 
                </Columns>
        </asp:GridView>
